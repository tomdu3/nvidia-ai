...
try:
    ...
    completion = client.chat.completions.create(
        ...
        messages=[
            {
                "role": "user",
                "content": "Can you tell me what is the best way to learn machine learning with ai. Give me some on line references, youtube tutorials and ai tools I can use for free.",
            }
        ],
        temperature=1,
        top_p=0.95,
